...
export default {
  ...
  methods: {
        ...
        series: [
          {
            ...
            data: [
              { value: 1, name: " 公共管理、社会保障" },
              { value: 4, name: " 电力、热力、燃气" },
              { value: 5, name: " 采矿业" },
              { value: 19, name: "其他" },
              { value: 22, name: " 农、林、牧、渔业" },
              { value: 33, name: " 水利、环境和公共设施" },
              { value: 37, name: " 卫生和社会工作" },
              { value: 41, name: " 金融业" },
              { value: 51, name: " 教育" },
              { value: 147, name: " 制造业" },
              { value: 174, name: " 交通运输、仓储和邮电" },
              { value: 196, name: " 房地产业" },
              { value: 244, name: " 建筑业" },
              { value: 295, name: " 居民服务、修理和其他" },
              { value: 354, name: " 住宿和餐饮业" },
              { value: 497, name: " 信息传输、软件" },
              { value: 534, name: " 文化、体育和娱乐业" },
              { value: 1135, name: " 科学研究和技术服务" },
              { value: 1832, name: " 租赁和商务服务业" },
              { value: 3312, name: " 批发和零售业" },
            ],
          },
        ],
      };
    ...
    bar_chart() {
      ...
      var datax = [
        1, 4, 5, 19, 22, 33, 37, 41, 51, 147, 174, 196, 244, 295, 354, 497, 534,
        1135, 1832, 3312,
      ];
      var datay = [
        "公共管理、社会保障",
  ...
  destroyed() {
    let _this = this;
    removeLayers(window.MAP, ["hhg-qiye-hl", "hhg-qiye"]);
