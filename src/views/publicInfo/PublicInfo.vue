...
export default {
  ...
  methods: {
    ...
    changeWMS(item) {
      ...
      switch (item.title) {
        ...
        case "医疗设施":
          ...
          add_tms(window.MAP, "hhg-jcss-med", "circle", circle);
          break;
        case "民政设施":
          removeLayers(window.MAP, [
            "hhg-jcss-pal",
          ...
          add_tms(window.MAP, "hhg-jcss-civ", "circle", circle);
          break;
        case "政法设施":
          removeLayers(window.MAP, [
            "hhg-jcss-pal",
          ...
          add_tms(window.MAP, "hhg-jcss-pal", "circle", circle);
          break;
      }
    },
    mouseEvent(){
    ...
    getInfo(e) {
      ...
      console.log(event,'ddsfsdf');
        ...
        if(features[0].layer.id.substring(0,8) == 'hhg-jcss'){
  ...
  destroyed() {
    let _this = this;
    removeLayers(window.MAP, ["hhg-jcss-med","hhg-jcss-pal", "hhg-jcss-edu", "hhg-jcss-civ"]);
