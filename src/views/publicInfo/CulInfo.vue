...
import { getCul } from "@/api/gzg/pubInfo.js";
...
export default {
  ...
  methods: {
    initLayers() {
      ...
      add_tms(window.MAP, "hhg-jcss-cul", "circle", circle);
      window.MAP.addLayer({
        id: "hhg-jcss-cul-hl",
        type: "circle",
        source: "hhg-jcss-cul",
        "source-layer": "hhg-jcss-cul",
        paint: {
          "circle-color": "#18ffff",
          "circle-radius": 8,
    ...
    getInfo(e) {
      ...
      if (features[0].layer.id == "hhg-jcss-cul") {
        var props = features[0].properties;
        window.MAP.setFilter("hhg-jcss-cul-hl",[
          "in",
          "myid",
